...
public class FosterPostController {
    
    @Autowired
    private FosterPostService fosterPostService;
    ...
    public Map<String, Object> userListFosterPosts(
        ...
        try {
            IPage<Map<String, Object>> pageResult = fosterPostService.userQueryFosterPosts(
    ...
    public Map<String, Object> userGetFosterPostDetail(@PathVariable Long id) {
        Map<String, Object> result = new HashMap<>();
        
        try {
            Map<String, Object> postDetail = fosterPostService.userGetFosterPostDetail(id);
            if (postDetail != null) {
                result.put("success", true);
    ...
    public Map<String, Object> userAddFosterPost(@RequestBody Map<String, Object> postRequest) {
        Map<String, Object> result = new HashMap<>();
        ...
        try {
            ...
            // 创建帖子对象
            FosterPost post = new FosterPost();
            ...
            post.setFosterRequirement((String) postRequest.get("fosterRequirement"));
            ...
            // 调用服务发布帖子
            boolean success = fosterPostService.userAddFosterPost(post);
    ...
    public Map<String, Object> userUpdateFosterPost(@RequestBody Map<String, Object> postRequest) {
        Map<String, Object> result = new HashMap<>();
        ...
        try {
            ...
            // 调用服务更新帖子
            boolean success = fosterPostService.userUpdateFosterPost(post, currentUserId);
    ...
    public Map<String, Object> userUpdateFosterPostStatus(
        ...
        try {
            ...
            boolean success = fosterPostService.userUpdateFosterPostStatus(id, status, currentUserId);
    ...
    public Map<String, Object> adminListFosterPosts(
            @RequestParam(defaultValue = "1") int page,
        ...
        try {
            IPage<Map<String, Object>> pageResult = fosterPostService.adminQueryFosterPosts(
    ...
    public Map<String, Object> adminGetFosterPostDetail(@PathVariable Long id) {
        Map<String, Object> result = new HashMap<>();
        
        try {
            Map<String, Object> postDetail = fosterPostService.adminGetFosterPostDetail(id);
            if (postDetail != null) {
                result.put("success", true);
                result.put("data", postDetail);
            } else {
    ...
    public Map<String, Object> adminDeleteFosterPost(@PathVariable Long id) {
        Map<String, Object> result = new HashMap<>();
        
        try {
            boolean success = fosterPostService.adminDeleteFosterPost(id);
    ...
    public Map<String, Object> adminUpdateFosterPost(@RequestBody FosterPost post) {
        Map<String, Object> result = new HashMap<>();
        
        try {
            boolean success = fosterPostService.adminUpdateFosterPost(post);
    ...
    public void exportFoster(
        ...
        try {
            ...
            response.setHeader("Content-Disposition", "attachment; filename=foster_" + System.currentTimeMillis() + ".xls");
            
            // 获取所有符合条件的寄养帖子数据（不分页）
            IPage<Map<String, Object>> pageResult = fosterPostService.adminQueryFosterPosts(
                    1, 100000, petType, petGender, breed, status);
            List<Map<String, Object>> fosterList = pageResult.getRecords();
            ...
            for (Map<String, Object> foster : fosterList) {
                sb.append("<tr>");
                sb.append("<td>").append(foster.get("id") != null ? foster.get("id") : "").append("</td>");
                sb.append("<td>").append(foster.get("title") != null ? foster.get("title") : "").append("</td>");
                sb.append("<td>").append(foster.get("petType") != null ? foster.get("petType") : "").append("</td>");
                sb.append("<td>").append(foster.get("petGender") != null ? foster.get("petGender") : "").append("</td>");
                sb.append("<td>").append(foster.get("petName") != null ? foster.get("petName") : "").append("</td>");
                sb.append("<td>").append(foster.get("breed") != null ? foster.get("breed") : "").append("</td>");
                sb.append("<td>").append(foster.get("location") != null ? foster.get("location") : "").append("</td>");
                sb.append("<td>").append(foster.get("status") != null ? foster.get("status") : "").append("</td>");
                sb.append("<td>").append(foster.get("userNickname") != null ? foster.get("userNickname") : "").append("</td>");
                sb.append("<td>").append(foster.get("userPhone") != null ? foster.get("userPhone") : "").append("</td>");
                sb.append("<td>").append(foster.get("createTime") != null ? foster.get("createTime") : "").append("</td>");
                sb.append("</tr>");
            }
