// pages/adoption-publish/adoption-publish.js
const app = getApp();
...
Page({
      ...
      if (res.success && res.data) {
        ...
        this.setData({
          formData: {
            ...
            breed: post.breed || '',
            health: post.vaccineStatus || '',
            description: post.description || '',
            contact: post.ownerInfo || '',
            location: post.location || ''
          },
          petTypeIndex: this.data.petTypes.indexOf(post.petType),
          genderIndex: this.data.genders.indexOf(post.petGender),
          imageList: post.photos ? post.photos.split(',') : []
        });
      } else {
        app.showToast('加载失败');
        setTimeout(() => {
  ...
  handleSubmit() {
    ...
    const apiUrl = isEdit ? '/adoption/user/update' : '/adoption/user/add';
